...
- [Especificación, ADR y diagramas de arquitectura federada](../modulos/mod03/ESPECIFICACION.md) — semana 4 (ver detalle abajo)
- [Contrato API y plan de integración](./contrato-api.md) — semana 5
- [Defensa de arquitectura y cambio práctico](../modulos/mod03/semana-06-defensa-parcial/README.md) — semana 6
- [Diseño de componentes y refactorización](../modulos/mod03/semana-07-componentes-refactor/README.md) — semana 7
